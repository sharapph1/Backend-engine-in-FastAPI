...
# project root (e.g. `alembic revision --autogenerate`).
# ---------------------------------------------------------------------------
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

# Import app settings and Base so autogenerate can detect all models.
...
# Override sqlalchemy.url with the value from our environment / .env file.
